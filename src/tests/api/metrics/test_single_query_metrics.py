...
class TestMetricTable(SmartTest):
    ...
    a_query_map = average_precision_score(values[:query_length, 1], values[:query_length, 0])
    ...
    b_query_map = average_precision_score(values[query_length:, 1], values[query_length:, 0])
