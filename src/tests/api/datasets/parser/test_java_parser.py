from api.datasets.parsing.java_class_parser import extract_java_identifiers, create_class_doc, extract_class_comments
...
class TestJavaParser(SmartTest):
    ...
    def test_sample_class(self):
        ...
        self.assertIn("someConstructorParameter", result, "missing constructor parameter")
        ...
        self.assertIn("some Constructor Parameter", result_cleaned, "missing constructor parameter")
        self.assertIn("some Method Parameter", result_cleaned, "missing method parameter")
