...
from api.technique.definitions.sampled.artifacts.calculator import sample_matrices, \
...
class TestSampledArtifactsCalculator(TestTechniqueHelper):
    ...
    def test_sampled_transitive_technique_calculator(self):
        calculator = SampledArtifactsTechniqueCalculator(self.get_sampled_technique_definition())
