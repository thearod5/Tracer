...
class TestSampledArtifactsTechnique(TestTechniqueHelper):
    def test_use_case(self):
        technique = SampledIntermediateTechnique(self.sampled_parameters,
    ...
    def test_get_symbol(self):
        self.assertEqual(SAMPLED_COMMAND_SYMBOL, SampledIntermediateTechnique.get_symbol())
    ...
    def test_combined_sampled(self):
        ...
        metrics_a = tracer.get_metrics(dataset, self.combined_sampled_artifacts_technique_name)
        metrics_b = tracer.get_metrics(dataset, self.combined_sampled_artifacts_technique_name)
